    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                // ✅ Save user object so Navbar can show the name/email
                                ...
                                <div>
                                    ...
                                    <div className="relative group">
                                        ...
                                        <input
                                            ...
                                            className={`w-full bg-white/5 border ${errors.name ? 'border-red-500/70' : 'border-white/10'
                                ...
                                <div>
                                    ...
                                    <div className="relative group">
                                        ...
                                        <input
                                            ...
                                            className={`w-full bg-white/5 border ${errors.email ? 'border-red-500/70' : 'border-white/10'
                                                } rounded-xl pl-12 pr-4 py-3.5 text-white placeholder-slate-500 focus:outline-none focus:border-violet-500/70 focus:bg-violet-500/5 transition-all`}
                                        />
                                    </div>
                                    {errors.email && (
                                ...
                                <div>
                                    ...
                                    <div className="relative group">
                                        ...
                                        <input
                                            ...
                                            className={`w-full bg-white/5 border ${errors.password ? 'border-red-500/70' : 'border-white/10'
                                        ...
                                        <div className="mt-2">
                                            <div className="flex gap-1 h-1">
                                                {[1, 2, 3, 4].map((level) => (
                                                    <div
                                                        key={level}
                                                        className={`flex-1 rounded-full transition-all duration-300 ${level <= strength ? strengthColor[strength] : 'bg-white/10'
                                                            }`}
                                                    />
                                                ))}
                                            </div>
                                ...
                                <div>
                                    ...
                                    <div className="relative group">
                                        ...
                                        <input
                                            ...
                                            className={`w-full bg-white/5 border ${errors.confirm ? 'border-red-500/70' : form.confirm && form.confirm === form.password ? 'border-green-500/50' : 'border-white/10'
                                                } rounded-xl pl-12 pr-12 py-3.5 text-white placeholder-slate-500 focus:outline-none focus:border-violet-500/70 focus:bg-violet-500/5 transition-all`}
                                        />
                                        <button
                                            type="button"
