...
export default function SuccessModal({ onClose }: SuccessModalProps) {
  ...
  return (
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm px-4">
      {/* Modal */}
      <div className="relative bg-slate-900 border border-slate-700 rounded-2xl p-10 w-full max-w-md text-center shadow-2xl">
        ...
        {status === "success" && (
          <div className="space-y-4">
            ...
            <p className="text-slate-400 text-sm">Redirecting in 3 seconds...</p>
          </div>
        )}
